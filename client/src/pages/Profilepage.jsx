    ...
    <div className="min-h-screen bg-cover bg-no-repeat flex items-center justify-center">
      <div className="w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse">
        ...
        >
          ...
          {/* Save Button */}
          <button
            className="bg-gradient-to-r from-purple-400 to-violet-600 text-white text-sm font-light py-2 px-6 rounded-full cursor-pointer hover:underline transition-all"
            type="submit"
          >
            Save
          </button>
        ...
        <img
          ...
          src={selectedImage ? URL.createObjectURL(selectedImage) : assets.logo_icon}
          alt="logo"
        />
      </div>
    </div>
