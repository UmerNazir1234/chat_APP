...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-[#282142]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${
    ...
    <div className="flex flex-col">
        {filteredUsers.map((user, index) =>(
            ...
            <div className="flex flex-col leading-5">
                 <p>{user.fullName}</p>
                 {
                    onlineUser.includes(user._id) ? <span className="text-green-400 text-xs">Online</span> :<span className="text-neutral-400 text-xs">Ofline</span>
                 }
